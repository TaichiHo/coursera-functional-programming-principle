...
abstract class TweetSet {
  ...
  /**
    * This is used to identify whether the set is empty or not
    */
  def isEmpty: Boolean
  ...
  /**
    * tw means the current found most retweeted tweet
    *
    * @param tw
    * @return
    */
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweetedAcc(tw: Tweet): Tweet = {
    if (tw.retweets > elem.retweets) left.mostRetweetedAcc(right.mostRetweetedAcc(tw))
...
object GoogleVsApple {
  ...
  lazy val allTweets: TweetList = TweetReader.allTweets.descendingByRetweet
}
